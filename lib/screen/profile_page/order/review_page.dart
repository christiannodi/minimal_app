...
class ReviewPage extends StatefulWidget {
  ...
  @override
  State<ReviewPage> createState() => _MustpayPageState();
}

class _MustpayPageState extends State<ReviewPage> {
  @override
  void initState() {
    super.initState();

    // ✅ Hanya fetch jika state belum ada
    context.read<GetorderpaidBloc>().add(Getorderreview());
  }
